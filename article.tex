...
\begin{figure}[H]
\centering
\subfigure[Plot of the signal, a keypoint and the corresponding patch.]{\includegraphics[width=.5\linewidth]{DiagramaConkeypoint.png}\label{patch}}
\subfigure[Orientations on each patch.]{\includegraphics[width=.5\linewidth]{histogramsbines.png}\label{histogrambines}}
